...
class bookingController extends Controller
{
    ...
    public function index()
    {
        ...
        return $crud->index(booking::all(), "reservas");
    }
    ...
    {
        $crud = new \App\Helpers\CRUD();
        return $crud->show(booking::find($id), "reservas con id:", $id);
    }
    ...
    public function destroy($id, Request $request)
    {
        ...
        if ($user->rol == "admin") { //administrador
            $crud = new \App\Helpers\CRUD();
            return $crud->destroy(booking::find($id), "booking", $id);
        } else {
            $response = array(
                'status' => 'error',
                'code'   => 404,
    ...
    */
    public function store(Request $request)
    {
        ...
        $crud = new \App\Helpers\CRUD();
        return $crud->store($atributos, "bookings", new booking());
    }
    ...
    */
    public function update($id, Request $request)
    {
        ...
        $crud = new \App\Helpers\CRUD();
        return $crud->update($atributos, "bookings", booking::find($id), $id, "id_booking");
    }
}
