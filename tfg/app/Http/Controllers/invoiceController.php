...
class invoiceController extends Controller
{
    ...
    public function index()
    {
        ...
        return $crud->index(invoice::all(), "facturas");
    }
    ...
    {
        $crud = new \App\Helpers\CRUD();
        return $crud->show(invoice::find($id), "factura con id:", $id);
    }
    ...
    public function destroy($id, Request $request)
    {
        ...
        if ($user->rol == "admin") { //administrador
            $crud = new \App\Helpers\CRUD();
            return $crud->destroy(invoice::find($id), "invoice", $id);
        } else {
            $response = array(
                'status' => 'error',
                'code'   => 404,
    ...
    */
    public function store(Request $request)
    {
        ...
        $crud = new \App\Helpers\CRUD();
        return $crud->store($atributos, "invoices", new invoice());
    }
