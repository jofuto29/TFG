...
class paysheetController extends Controller
{
    ...
    public function index()
    {
        ...
        return $crud->index(paysheet::all(), "nominas");
    }
    ...
    {
        $crud = new \App\Helpers\CRUD();
        return $crud->show(paysheet::find($id), "nomina con id", $id);
    }
    ...
    public function destroy($id, Request $request)
    {
        ...
        if ($user->rol == "admin") { //administrador
            $crud = new \App\Helpers\CRUD();
            return $crud->destroy(paysheet::find($id), "nomina", $id);
        } else {
            $response = array(
                'status' => 'error',
                'code'   => 404,
    ...
    */
    public function store(Request $request)
    {
        ...
        $crud = new \App\Helpers\CRUD();
        return $crud->store($atributos, "paysheets", new paysheet());
    }
    ...
    */
    public function update($id, Request $request)
    {
        ...
        $crud = new \App\Helpers\CRUD();
        return $crud->update($atributos, "paysheets", paysheet::find($id), $id, "id_paysheet");
    }
}
