...
class deductionController extends Controller
{
    ...
    public function index()
    {
        ...
        return $crud->index(deduction::all(), "descuentos o incrementos");
    }
    ...
    {
        $crud = new \App\Helpers\CRUD();
        return $crud->show(deduction::find($id), "decuento o incremento con id:", $id);
    }
    ...
    public function destroy($id, Request $request)
    {
        ...
        if ($user->rol == "admin") { //administrador
            $crud = new \App\Helpers\CRUD();
            return $crud->destroy(deduction::find($id), "deductions", $id);
        } else {
            $response = array(
                'status' => 'error',
                'code'   => 404,
    ...
    */
    public function store(Request $request)
    {
        ...
        $crud = new \App\Helpers\CRUD();
        return $crud->store($atributos, "deductions", new deduction());
    }
    ...
    */
    public function update($id, Request $request)
    {
        ...
        $crud = new \App\Helpers\CRUD();
        return $crud->update($atributos, "deductions", deduction::find($id), $id, "id_deduction");
    }
}
