...
class SupplierController extends Controller
{
    ...
    public function index()
    {
        ...
        return $crud->index(supplier::all(), "proeevedores");
    }
    ...
    {
        $crud = new \App\Helpers\CRUD();
        return $crud->show(supplier::find($id), "proeevedor", $id);
    }
    ...
    public function destroy($id, Request $request)
    {
        ...
        if ($user->rol == "admin") { //administrador
            ...
            $crud = new \App\Helpers\CRUD();
            return $crud->destroy(supplier::find($id), "proeevedor", $id);
        } else {
            $response = array(
                'status' => 'error',
                'code'   => 404,
    ...
    */
    public function store(Request $request)
    {
        ...
        $crud = new \App\Helpers\CRUD();
        return $crud->store($atributos, "suppliers", new supplier()); //la segunda variable se utiliza para la regla de validacion
    }
    ...
    */
    public function update($id, Request $request)
    {
        ...
        $crud = new \App\Helpers\CRUD();
        return $crud->update($atributos, "suppliers", supplier::find($id), $id, "id_supplier");
    }
}
